...
//    public static void saveList(String key, Object obj, int seconds) {
//        List<QuestionSendVO> list = getBean(key,ArrayList.class);
//        if(list!= null)
//            list.add((QuestionSendVO) obj);
//        else{
//            list = new ArrayList<>();
//            list.add((QuestionSendVO)obj);
//        }
//        cacheUtils.redisTemplate.opsForValue().set(key, JSON.toJSONString(list), seconds, TimeUnit.SECONDS);
//    }
//
//    public static boolean isInList(String key, Integer questionId) {
//        List<JSONObject> list = getBean(key,ArrayList.class);
//        if(list!= null){
//            for(int i = 0;i<list.size();i++){
//                QuestionSendVO question = JSON.parseObject(list.get(i).toJSONString(),QuestionSendVO.class);
